"""
Django settings for soulfitpro project.q
...
WSGI_APPLICATION = 'soulfitpro.wsgi.application'
...
#DATABASES = {
    #'default': {
     #   'ENGINE': 'MongoDB 7.0.3 Community',
      #  'NAME': 'soulfit',
       # 'ENFORCE_SCHEMA': False,  # Set to True if you want to enforce a schema on MongoDB
        #'CLIENT': {
         #   'host': 'localhost',
          #  'port': 27017,
           # 'username': 'vasanth',
            #'password': 'itisthatis',
            #'authSource': 'admin',  # Replace with the authentication source if needed
        #}
    #}
#}
